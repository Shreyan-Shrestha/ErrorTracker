...
use App\Helpers\NepaliDate\src\Exceptions\InvalidNepaliDateLocale;
...
trait useLocale
{
    ...
    private static array $numberConverters = [
        'en' => null,
        'np' => [\App\Helpers\NepaliDate\src\NepaliNumbers::class, 'convertToNepali'],
    ];
    ...
    {
        if (!$locale) {
            $locale = static::getGlobalDefaultLocale();
        }
    ...
    {
        $locale = $locale ?? static::getGlobalDefaultLocale();
