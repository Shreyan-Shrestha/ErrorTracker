...
use App\Helpers\NepaliDate\src\NepaliNumbers;

/**
 * @property int $year
 * @property int $month
 * @method static \DateTimeZone resolveTimeZone(\DateTimeZone|string|null $timezone)
 */
trait haveDateParse
{
    abstract public static function getLocalePartFor(string $part, string $locale): array;
    abstract protected static function getIndexFromShortMonths(string $month): ?int;
    abstract protected static function getIndexFromMonths(string $month): ?int;
    abstract protected static function getIndexFromShortWeekDays(string $day): ?int;
    abstract protected static function getIndexFromWeekDays(string $day): ?int;
    abstract public static function fromTimestamp(int $timestamp, string|DateTimeZone|null $timezone = null): static;
    abstract public static function now(string|DateTimeZone|null $timezone = null): static;
    abstract public function shiftToNearWeek(int $weekday, bool $up = true): static;
