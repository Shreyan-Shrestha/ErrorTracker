...
use App\Helpers\NepaliDate\src\Exceptions\NepaliDateOutOfBoundsException;
use App\Helpers\NepaliDate\src\NepaliUnit;
use App\Helpers\NepaliDate\src\NepaliWeekDay;
...
{
    abstract function castInstance(): static;
    abstract function setDayOfWeek(): static;
