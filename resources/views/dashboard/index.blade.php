...
<div id="content" class="w-full p-3 md:p-6">
    <div class="grid gap-4 mt-6 md:gap-16 is-drawer-open:gap-10 grid-cols-2 lg:grid-cols-4 p-6">
        <x-stat-card class="border-primary" title="Total Projects" value="425" iconBg="text-primary" iconColor="bg-blue-100">
            <x-slot:icon>
        ...
        <x-stat-card class="border-success" title="Users" value="30" change="All Time" iconColor="text-success-content" iconBg="bg-green-100">
            <x-slot:icon>
        ...
        <x-stat-card class="border-warning" title="Errors Reported" value="114" iconBg="bg-orange-100" iconColor="text-warning-content">
            <x-slot:icon>
        ...
        <x-stat-card class="border-red-600" title="Critical Errors" value="7" iconBg="bg-red-100" iconColor="text-red-600">
            <x-slot:icon>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-exclamation-diamond size-5" viewBox="0 0 16 16">
