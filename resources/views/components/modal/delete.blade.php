...
<dialog id="modal_delete" class="modal">
    <div class="modal-box w-md sm:w-full ">
        ...
        <div class="flex gap-8 justify-center-safe mt-6 p-3 border-t-2 border-t-gray-400 bg-base-300">
            <form method="dialog">
                <button class="btn btn-wide border-gray-400 btn-xs sm:btn-sm md:btn-md">Cancel</button>
            </form>

            <form id="delete_form" action="" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-xs sm:btn-sm md:btn-md bg-red-700 text-base-300 shadow-sm">
