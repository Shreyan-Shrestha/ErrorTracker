...
<div id="content" class="w-full p-6 hidden">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <x-stat-card title="Total Users" class="border-primary" value="1,284" change="+12%" desc="this month" iconColor="text-primary" iconBg="bg-blue-100">
            <x-slot:icon>
        ...
        <x-stat-card title="Active Now" class="border-success" value="342" desc="Real-time sessions" iconColor=" text-green-800" iconBg="bg-green-100">
            <x-slot:icon>
        ...
        <x-stat-card title="Pending invites" class="border-warning" value="18" desc="Requiring verification" iconColor="text-orange-800" iconBg="bg-orange-100">
            <x-slot:icon>
